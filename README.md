...
* **Video Support**: Automatically handles **WebM**, **MP4**, and **GIF** videos. Thumbnails are marked with a corresponding red tag (e.g., "MP4"), and previews allow you to open the video in your default browser.
...
4. **Select**: Wait for thumbnails to populate.
   * **Images**: Normal thumbnail.
   * **Videos**: Marked with a Red tag (WEBM, MP4, GIF).
   * **Left-click** to select/deselect.
   * **Right-click** to preview (Videos will have a "Play" button).
